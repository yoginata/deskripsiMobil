public class Pajero extends Mobil implements SUV, MPV {
    private String warna;
    private String mesin;

    public Pajero(String nama, String merk, String warna, String mesin) {
        super(nama, merk);
        this.warna = warna;
        this.mesin = mesin;
    }
    ...
    public void displayTipe() {
        ...
        System.out.println("Jenis Mobil : " + SUV1);
    }
